...
<body>
    ...
    <div id="container">
        ...
        <div id="dot2"></div>
        <div id="screen">
            <div id="header">FOR GUEST</div>
            <div id="messageDisplaySection">
                <!-- bot messages -->
                <img src="https://www.techopedia.com/wp-content/uploads/2023/03/6e13a6b3-28b6-454a-bef3-92d3d5529007.jpeg" class="avatar" ><div class="chat botMessages">Hii.. It's your Chatbot..Vanakkoo!!</div>
