...
if (isset($_POST["signup"])) {
  ...
  if ($check_email > 0) {
    ?>
      ...
      <?php 
  } else if(strlen($_POST["signup_bv_id"])==6){
      ...
      <div class="signin-signup">
        <form action="" class="sign-in-form" method="post">
          ...
          <div class="input-field">
            ...
            <input type="text" placeholder="Student ID" name="bv_id" pattern="([0-9][0-9][A-Z][A-Z][0-9][0-9])" minlength="6" title="Please enter correct Student ID in capital letters" value="<?php echo $_POST['bv_id']; ?>" required />
          </div>
          <div class="input-field">
        ...
        <form action="" class="sign-up-form" method="post">
          ...
          <div class="input-field">
            <i class="fas fa-user"></i>
            <input type="text" placeholder="Student ID" name="signup_bv_id" pattern="([0-9][0-9][A-Z][A-Z][0-9][0-9])" minlength="6" title="Please enter correct Student ID in capital letters"  value="<?php echo $_POST["signup_bv_id"]; ?>" required />
          </div>
          <div class="input-field">
            <i class="fas fa-envelope"></i>
            <input type="email" placeholder="PSG Email" name="signup_bv_emailid" pattern=".+@psgtech\.ac\.in" title="Please enter a valid PSG email id only" size="50" value="<?php echo $_POST["signup_bv_emailid"]; ?>" required />
          </div>
          <div class="input-field">
            <i class="fas fa-lock"></i>
